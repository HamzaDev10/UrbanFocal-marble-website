    <footer class="main">
        <section class="bg-white p-30 text-white wow fadeIn animated" style="visibility: visible;">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <!-- Subscribe Form -->
                <form class="form-subscriber wow fadeIn animated" style="visibility: visible;">
                    <div class="row">
                        <div class="col-md-6">
                        <div class="form-group mb-2">
                        <input type="text" class="form-control bg-white font-small" placeholder="Enter your name" required>
                         </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                        <div class="form-group mb-2">
                         <input type="tel" class="form-control bg-white font-small" 
                        ...
                        <div class="col-md-6">
                        <div class="form-group mb-2">
                         <input class="form-control bg-white font-small" rows="2"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        <div class="form-group mb-2">
                         <textarea class="form-control bg-white font-small" rows="5" placeholder="Enter your Message" required></textarea>
                         </div>
                        </div>
                    </div>
