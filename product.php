                                ...
                                <!-- <div class="col-md-5 col-sm-12 col-xs-12">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            ...
                                            <figure class="border-radius-10">
                                                <img src="assets/imgs/shop/product-2-2.webp" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="assets/imgs/shop/product-3-2.webp" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="assets/imgs/shop/product-4-2.webp" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="assets/imgs/shop/product-7-1.webp" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                        ...
                                        <div class="slider-nav-thumbnails pl-15 pr-15">
                                            ...
                                            <div><img src="assets/imgs/shop/product-3-2.webp" alt="product image"></div>
                                            <div><img src="assets/imgs/shop/product-4-1.webp" alt="product image"></div>
                                            <div><img src="assets/imgs/shop/product-5-1.webp" alt="product image"></div>
                                            <div><img src="assets/imgs/shop/product-6-1.webp" alt="product image"></div>
                                    ...
                                    <div class="social-icons single-share">
                                        <ul class="text-grey-5 d-inline-block">
                                            ...
                                            <li class="social-facebook"><a href="shop-product-right.html#"><img src="assets/imgs/theme/icons/icon-facebook.svg" alt=""></a></li>
                                            <li class="social-twitter"> <a href="shop-product-right.html#"><img src="assets/imgs/theme/icons/icon-twitter.svg" alt=""></a></li>
                                            <li class="social-instagram"><a href="shop-product-right.html#"><img src="assets/imgs/theme/icons/icon-instagram.svg" alt=""></a></li>
        ...
        <img class="thumb" src="assets/imgs/shop/product-8-1.webp">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        ...
                                        <span class="in-soid text-success">in stock</span>
                                        ...
                                        <div class="clearfix product-price-cover mt-2">
                                        ...
                                        <!-- <div class="attr-detail attr-color mb-15">
                                            ...
                                            <ul class="list-filter color-filter">
                                                <li><a href="shop-product-right.html#" data-color="Red"><span class="product-color-red"></span></a></li>
                                                <li><a href="shop-product-right.html#" data-color="Yellow"><span class="product-color-yellow"></span></a></li>
                                                <li class="active"><a href="shop-product-right.html#" data-color="White"><span class="product-color-white"></span></a></li>
                                                <li><a href="shop-product-right.html#" data-color="Orange"><span class="product-color-orange"></span></a></li>
                                                <li><a href="shop-product-right.html#" data-color="Cyan"><span class="product-color-cyan"></span></a></li>
                                                <li><a href="shop-product-right.html#" data-color="Green"><span class="product-color-green"></span></a></li>
                                                <li><a href="shop-product-right.html#" data-color="Purple"><span class="product-color-purple"></span></a></li>
                                            </ul>
                                        </div>
                                        <div class="attr-detail attr-size">
                                            <strong class="mr-10">Size</strong>
                                            <ul class="list-filter size-filter font-small">
                                                <li><a href="shop-product-right.html#">S</a></li>
                                                <li class="active"><a href="shop-product-right.html#">M</a></li>
                                                <li><a href="shop-product-right.html#">L</a></li>
                                                <li><a href="shop-product-right.html#">XL</a></li>
                                                <li><a href="shop-product-right.html#">XXL</a></li>
                                            </ul>
                                        </div> -->
                                        <div class="bt-1 border-color-1 mt-30 mb-30"></div>
                                        <div class="detail-extralink">
                                            <div class="detail-qty border radius">
                                                <a href="shop-product-right.html#" class="qty-down"><i class="fi-rs-angle-small-down"></i></a>
                                                <span class="qty-val">1</span>
                                                <a href="shop-product-right.html#" class="qty-up"><i class="fi-rs-angle-small-up"></i></a>
                                            </div>
                                        ...
                                        <!-- <ul class="product-meta font-xs color-grey mt-50">
                                            <li class="mb-5">SKU: <a href="shop-product-right.html#">FWM15VKT</a></li>
                                            <li class="mb-5">Tags: <a href="shop-product-right.html#" rel="tag">Cloth</a>, <a href="shop-product-right.html#" rel="tag">Women</a>, <a href="shop-product-right.html#" rel="tag">Dress</a> </li>
                            ...
                            <div class="tab-style3">
                                <ul class="nav nav-tabs text-uppercase">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="Description-tab" data-bs-toggle="tab" href="shop-product-right.html#Description">Description</a>
                                    </li>
                                    <!-- <li class="nav-item">
                                        <a class="nav-link" id="Additional-info-tab" data-bs-toggle="tab" href="shop-product-right.html#Additional-info">Additional info</a>
                                    </li> -->
                                    <li class="nav-item">
                                        <a class="nav-link" id="Reviews-tab" data-bs-toggle="tab" href="shop-product-right.html#Reviews">Reviews (3)</a>
                                    </li>
                                </ul>
                                                    ...
                                                    <div class="comment-list">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="assets/imgs/icons/user-icon.jpg" alt="">
                                                                   
                                                                </div>
                                                                <div class="desc">
                                                                     <h6><a href="shop-product-right.html#">Ethan Walker</a>
                                                                    <span class="font-xxs"> - December 4</span>
                                                                    </h6>
                                                                    <p>Great experience! My order arrived in just 3 days from Poland. Super quick delivery and everything was perfect.</p>
                                                                    <div class="d-flex justify-content-between">
                                                                        <div class="d-flex align-items-center">
                                                                            <!-- <p class="font-xs mr-30">December 4, 2020 at 3:12 pm </p> -->
                                                                            <!-- <a href="shop-product-right.html#" class="text-brand btn-reply">Reply <i class="fi-rs-arrow-right"></i> </a> -->
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                       ...
                                                       <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                ...
                                                                <div class="desc">
                                                                     <h6><a href="shop-product-right.html#">Henry Wilson</a>
                                                                    <span class="font-xxs"> - October 15</span>
                                                                    </h6>
                                                                    <p>Fast and reliable service. Delivery took just 3 days from Poland. Will definitely order again.</p>
                                                                    <div class="d-flex justify-content-between">
                                                                        <div class="d-flex align-items-center">
                                                                            <!-- <p class="font-xs mr-30">December 4, 2020 at 3:12 pm </p> -->
                                                                            <!-- <a href="shop-product-right.html#" class="text-brand btn-reply">Reply <i class="fi-rs-arrow-right"></i> </a> -->
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                ...
                                                                <div class="desc">
                                                                     <h6><a href="shop-product-right.html#">William Brown</a>
                                                                    <span class="font-xxs"> - January 8</span>
                                                                    </h6>
                                                                    <p>Great experience! My order arrived in just 3 days from Poland. Super quick delivery and everything was perfect.</p>
                                                                    <div class="d-flex justify-content-between">
                                                                        <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                ...
                                                                <div class="desc">
                                                                     <h6><a href="shop-product-right.html#">James Anderson</a>
                                                                    <span class="font-xxs"> - November 28</span>
                                                                    </h6>
                                                                    <p>Really impressed with the shipping speed. Got my package from Poland in only 3 days. Highly recommended!</p>
                                                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="comment-form">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8 col-md-12">
                                                    <form class="form-contact comment_form" action="shop-product-right.html#" id="commentForm">
                                                        <div class="row">
                                                            <div class="col-12">
                                    ...
                                    <div class="row related-products">
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up mb-0">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="shop-product-right.html" tabindex="0">Dadua Camera 4K 2026EF</a></h2>
                                                    <div class="rating-result" title="90%">
                                                        <span>
                                                        </span>
                                                    </div>
